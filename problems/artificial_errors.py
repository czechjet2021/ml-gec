...
class ArtificialErrors(text_problems.Text2TextProblem):
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        glob_pattern = '/home/azureuser/cloudfiles/code/Users/jsvojgr05/low-resource-gec-wnut2019/data/chunks/{}/{}-{}-{}-{}/*'.format(args.lang, args.token_err_prob, args.token_err_distribution, args.char_err_prob, args.char_err_distribution)
